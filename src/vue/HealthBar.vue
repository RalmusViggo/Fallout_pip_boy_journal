...
<script lang="js">
import IncrementMenu from '/src/vue/IncrementMenu.vue';
import isDarkColor from '/src/isDarkColor.js';
import HealthBarProgress from '/src/vue/HealthBarProgress.vue';
